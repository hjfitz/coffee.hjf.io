...
const Calculator = ({ratioWater, ratioCoffee = 1, name, src}: CalculatorProps) => {
	...
	return (
		<div className="flex flex-col h-full">
			...
			<section class="flex-1 bg-gray-100 rounded-t-lg flex flex-col items-center justify-evenly">
				<div class="w-64 pb-8">
	...
	return (
		<main className="h-full flex flex-col justify-between">
			<div className="bg-indigo-900 flex-1">
				<section className="container mx-auto max-w-2xl pt-8 h-full flex flex-col">
			...
			<div className="bg-grey-100 basis-1/3">
				<section className="container mx-auto max-w-2xl flex flex-wrap justify-between pb-16 items-end min-h-full px-8">
					{styles.map((style) => {
						return (
							<div 
								className="inline drop-shadow-sm hover:drop-shadow-md rounded-lg bg-gradient-to-r from-sky-400 to-sky-300 hover:from-sky-500 hover:to-sky-400 ease-linear transition-all py-2 px-4 my-2 cursor-pointer" 
